...
window.navigator={
    appCodeName: "Mozilla",
    appName: "Netscape",
    appVersion: "Mozilla/4.0 (Windows; MSIE 6.0; Windows NT 5.2",
    cookieEnabled: true,
    deviceMemory: 8,
    doNotTrack: null,
...
window._$jsvmprt = function (b, a, f) {
    ...
    function n(b) {
        return function (b) {
            if (Array.isArray(b)) {
                for (var a = 0, f = new Array(b.length); a < b.length; a++) f[a] = b[a];
                return f
            }
        }(b) || function (b) {
    ...
    function F(b, a, f) {
        for (var e = a; e < a + f;) {
            var d = y(b, e);
            B[e] = d, e += 2;
            k[d] ? (W[e] = u(b, e), e += 2) : _[d] ? (W[e] = s(b, e), e += 4) : M[d] ? (W[e] = p(b, e), e += 8) : H[d] ? (W[e] = y(b, e), e += 2) : J[d] ? (W[e] = v(b, e), e += 4) : N[d] && (W[e] = v(b, e), e += 4)
        }
    }
    ...
    function G(b, a, f, e, c, l, m, I) {
        ...
        if (!I)
            for (; O < E;) {
                ...
                if (x >>= 2, A > 2) {
                    A = 3 & x;
                    if (x >>= 2, A > 2)(A = x) < 2 ? (C = S[R--], S[R] = S[R] < C) : A < 9 ? (z = y(b, O), O += 2, S[R] = S[R][z]) : A < 11 ? S[++R] = !0 : A < 13 ? (C = S[R--], S[R] = S[R] >>> C) : A < 15 && (S[++R] = p(b, O), O += 8);
                    else if (A > 1) {
                        (A = x) < 6 || (A < 8 ? C = S[R--] : A < 10 ? (C = S[R--], S[R] = S[R] ^ C) : A < 12 && (z = s(b, O), t[++o] = [
                            [O + 4, z - 3], 0, 0
                        ], O += 2 * z - 2))
                    } else if (A > 0) {
                        if ((A = x) > 7) C = S[R--], S[R] = S[R] in C;
                        else if (A > 5) S[R] = ++S[R];
                        else if (A > 3) z = y(b, O), O += 2, C = c[z], S[++R] = C;
                        else if (A > 1) {
                            var D = 0,
                                T = S[R].length,
                                $ = S[R];
                    ...
                    if (x >>= 2, A > 2)(A = x) > 7 ? (C = S[R--], S[R] = S[R] | C) : A > 5 ? (z = y(b, O), O += 2, S[++R] = c["$" + z]) : A > 3 && (z = s(b, O), t[o][0] && !t[o][2] ? t[o][1] = [O + 4, z - 3] : t[o++] = [0, [O + 4, z - 3], 0], O += 2 * z - 2);
                        ...
                        if ((A = x) > 13) S[++R] = !1;
                        else if (A > 6) C = S[R--], S[R] = S[R] instanceof C;
                        else if (A > 4) C = S[R--], S[R] = S[R] % C;
                        else if (A > 2)
                            if (S[R--]) O += 4;
                            else {
                                if ((z = s(b, O)) < 0) {
                                    I = 1, F(b, a, 2 * f), O += 2 * z - 2;
                                    break
                                }
                                O += 2 * z - 2
                            }
                    ...
                    if (x >>= 2, A > 2)
                        ...
                        O += 2 * z - 2
                    } else A < 5 ? (C = S[R--], S[R] = S[R] / C) : A < 7 ? (C = S[R--], S[R] = S[R] !== C) : A < 14 && (S[++R] = l);
                    else if (A > 1) {
                        ...
                        if ((A = x) < 8) q = S[R--], C = delete S[R--][q];
                            ...
                            for (z = v(b, O), A = "", P = i.q[z][0]; P < i.q[z][1]; P++) A += String.fromCharCode(r ^ i.p[P]);
                            O += 4, S[R] = S[R][A]
                        } else A < 12 ? (C = S[R--], S[R] = S[R] << C) : A < 14 && (S[++R] = u(b, O), O += 2)
                    } else {
                        if ((A = x) < 5) {
                            z = s(b, O);
                            try {
                            ...
                            O += 2 * z - 2
                        } else A < 7 ? (z = y(b, O), O += 2, S[R -= z] = 0 === z ? new S[R] : d(S[R], n(S.slice(R + 1, R + z + 1)))) : A < 9 && (C = S[R--], S[R] = S[R] & C)
                    }
                } else {
                    A = 3 & x;
                    if (x >>= 2, A < 1) {
                        if ((A = x) < 1) return [1, S[R--]];
                        if (A < 5) C = S[R--], S[R] = S[R] * C;
                        else if (A < 7) C = S[R--], S[R] = S[R] != C;
                        else if (A < 14) q = S[R--], w = S[R--], (A = S[R--]).x === G ? A.y >= 1 ? S[++R] = K(b, A.c, A.l, q, A.z, w, null, 1) : (S[++R] = K(b, A.c, A.l, q, A.z, w, null, 0), A.y++) : S[++R] = A.apply(w, q);
                        else if (A < 16) {
                            z = s(b, O), (U = function a() {
                                var f = arguments;
                                return a.y > 0 ? K(b, a.c, a.l, f, a.z, this, null, 0) : (a.y++, K(b, a.c, a.l, f, a.z, this, null, 0))
            ...
            for (; O < E;) {
                ...
                if (x >>= 2, A > 2) {
                    ...
                    if (x >>= 2, A < 1) {
                        ...
                        (A = x) > 10 ? (z = W[O], t[++o] = [
                            [O + 4, z - 3], 0, 0
                        ], O += 2 * z - 2) : A > 8 ? (C = S[R--], S[R] = S[R] ^ C) : A > 6 && (C = S[R--])
                    } else {
                        (A = x) < 2 ? (C = S[R--], S[R] = S[R] < C) : A < 9 ? (z = W[O], O += 2, S[R] = S[R][z]) : A < 11 ? S[++R] = !0 : A < 13 ? (C = S[R--], S[R] = S[R] >>> C) : A < 15 && (S[++R] = W[O], O += 8)
                    }
                } else if (A > 1) {
                    A = 3 & x;
                    if (x >>= 2, A > 2)(A = x) < 5 ? (z = W[O], t[o][0] && !t[o][2] ? t[o][1] = [O + 4, z - 3] : t[o++] = [0, [O + 4, z - 3], 0], O += 2 * z - 2) : A < 7 ? (z = W[O], O += 2, S[++R] = c["$" + z]) : A < 9 && (C = S[R--], S[R] = S[R] | C);
                    else if (A > 1) {
                        if ((A = x) > 13) S[++R] = !1;
                        else if (A > 6) C = S[R--], S[R] = S[R] instanceof C;
                        else if (A > 4) C = S[R--], S[R] = S[R] % C;
                        else if (A > 2) S[R--] ? O += 4 : O += 2 * (z = W[O]) - 2;
                        else if (A > 0) {
                        ...
                        (A = x) > 13 ? (S[++R] = W[O], O += 4) : A > 11 ? (C = S[R--], S[R] = S[R] >> C) : A > 9 ? (z = W[O], O += 2, C = S[R--], c[z] = C) : A > 7 ? (z = W[O], O += 4, q = R + 1, S[R -= z - 1] = z ? S.slice(R, q) : []) : A > 0 && (C = S[R--], S[R] = S[R] > C)
                    }
                } else if (A > 0) {
                    A = 3 & x;
                    if (x >>= 2, A < 1)
                        ...
                        (A = x) > 12 ? S[++R] = l : A > 5 ? (C = S[R--], S[R] = S[R] !== C) : A > 3 ? (C = S[R--], S[R] = S[R] / C) : A > 1 ? O += 2 * (z = W[O]) - 2 : A > -1 && (S[R] = !S[R])
                    }
                } else {
                    A = 3 & x;
                    if (x >>= 2, A > 2)(A = x) < 1 ? S[++R] = null : A < 3 ? (C = S[R--], S[R] = S[R] >= C) : A < 12 && (S[++R] = void 0);
                    else if (A > 1) {
                        if ((A = x) < 7) S[R] = h(S[R]);
                        else if (A < 9) {
                        ...
                        var U;
                        if ((A = x) > 14) z = W[O], (U = function a() {
                            var f = arguments;
                            return a.y > 0 ? K(b, a.c, a.l, f, a.z, this, null, 0) : (a.y++, K(b, a.c, a.l, f, a.z, this, null, 0))
                        }).c = O + 4, U.l = z - 2, U.x = G, U.y = 0, U.z = c, S[R] = U, O += 2 * z - 2;
                        else if (A > 12) q = S[R--], w = S[R--], (A = S[R--]).x === G ? A.y >= 1 ? S[++R] = K(b, A.c, A.l, q, A.z, w, null, 1) : (S[++R] = K(b, A.c, A.l, q, A.z, w, null, 0), A.y++) : S[++R] = A.apply(w, q);
    ...
    function K(b, a, f, e, d, c, n, i) {
        ...
        for (t = 0, l = o.length = e.length; t < l; t++) o[t] = e[t];
        return i && !B[a] && F(b, a, 2 * f), B[a] ? G(b, a, f, 0, o, c, null, 1)[1] : G(b, a, f, 0, o, c, null, 0)[1]
    }
},
...
cookies = 'csrftoken=8cc92619eeabd0c1a641b7664afbbb3d; tt_webid=6886359963037550093; ttcid=dc2242443f7e4e45b9035a4637f0ecda41; csrftoken=8cc92619eeabd0c1a641b7664afbbb3d; FRM=new; PIXIEL_RATIO=1.25; WIN_WH=1536_754; csrftoken=8cc92619eeabd0c1a641b7664afbbb3d; __ac_signature=_02B4Z6wo00f01fup.JwAAIDCMxU1gmQp4hH7jfgAAB7byhkE5LfYwwmlIHvveQ9qGJmcdSrzoxQ8YCOG6hDT.Qoy9hDplj3UyrNNDDLkgunjBe-6RcTGokbEQkg9g8IjncANo1zGpL9U.UyDca; _tea_utm_cache_2256={%22utm_source%22:%22mobile_qq%22%2C%22utm_medium%22:%22toutiao_android%22%2C%22utm_campaign%22:%22client_share%C3%97tamp%22}; s_v_web_id=verify_kllust9a_6nceO9is_gN2o_4892_BNGp_NZvApliz7d8p; MONITOR_WEB_ID=1a8ff256-7115-4e39-b884-eb71ff79def0; tt_scid=1iqo6HeoS1fxZqP6hTJ7VEHGfYRNVPY2FzlDZUKX8Vbv45TMni8idTUs7WFP32qC9765'
...
var res = get_page('https://www.toutiao.com/api/pc/feed/?min_behot_time=0&category=__all__&utm_source=toutiao&widen=1&tadrequire=true');
console.log(res);
